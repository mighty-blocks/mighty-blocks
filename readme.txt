...
1. Text Controls
2. Box and Text Shadow Controls
3. Spacings Controls
4. Colors Controls
5. Border Controls
...
= Is Mighty Blocks free? =
Yes!

= How do I start using Mighty Blocks? =
You will need to have either WordPress v.5.0+, or the official [Gutenberg plugin](https://wordpress.org/plugins/gutenberg/) to get started.

= What WordPress themes work with Mighty Blocks? =
Mighty Blocks works with any theme that is following WordPress coding standards.
